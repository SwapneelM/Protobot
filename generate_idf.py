...
def generate_idf():
	filepath = '/home/rudresh/Documents/be-project/articles'
	file_paths_list = generate_filepath_list(filepath)	
	#word_dict = {}
	#word_dict['document_count_frequency'] = 0

	with open('idf_lookup2.json','r') as myfile:
	...
	for filepath in file_paths_list:
		...
		for word in word_count:
			if word in word_dict:
				...
				word_dict[word] = 1
	with open('idf_lookup2.json','w') as fp:	
...
def make_query(query):
	...
	filepath = '/home/rudresh/Documents/be-project/freq2_stats'
